...
## TODO
- fix server actions to improve sql - createPlan, createWorkout, deletePlan
- use optimistic updates in react query. maybe useMutation too. currently we just invalidate the cache and refetch.
